...
import { getAllPolls, postVoteOnPole } from '../../services/poll/poll';
    ...
    const handleAddVote = async (pollId, optionId) => {
        ...
        try {
            ...
            if (error.response && error.response.status === 406) {
                enqueueSnackbar(`Poll has been expired and can not be voted on`, { variant: 'error', autoHideDuration: 5000 });
                fetchData();
            } else {
